...
from modeling_unilm import UnilmConfig,UnilmForLM
...
MODEL_CLASSES = {
    'unilm': (UnilmConfig, UnilmForLM, UnilmTokenizer)
}
...
def main():
    ...
    if args.do_train:
        ...
        bi_uni_pipeline = [
                            # utils_seq2seq.Preprocess4BiLM(args.max_pred, args.mask_prob, list(tokenizer.vocab.keys()),
                           ...
                           # utils_seq2seq.Preprocess4LeftLM(args.max_pred, args.mask_prob, list(tokenizer.vocab.keys()),
                           #                               tokenizer.convert_tokens_to_ids, args.max_seq_length,
                           #                               mask_source_words=False, skipgram_prb=args.skipgram_prb,
                           #                               skipgram_size=args.skipgram_size,
                           #                               mask_whole_word=args.mask_whole_word,
                           #                               tokenizer=data_tokenizer),
                           utils_seq2seq.Preprocess4RightLM(args.max_pred, args.mask_prob, list(tokenizer.vocab.keys()),
                                                           tokenizer.convert_tokens_to_ids, args.max_seq_length,
                                                           mask_source_words=False, skipgram_prb=args.skipgram_prb,
                                                           skipgram_size=args.skipgram_size,
                                                           mask_whole_word=args.mask_whole_word,
...
if __name__ == "__main__":
    ...
    python -u run_seq2seq.py --data_dir data/   \
        ...
        --model_type unilm  \
        --model_name_or_path data/pretrain/   \
        ...
        --do_lower_case   \
        --train_batch_size 8   \
        --model_recover_path data/pretrain/ \
        --num_train_epochs 10  \
        --mask_prob  0.4  \
        --learning_rate  8e-5
